...
where
    FC::F: PrimeField64,
{
    // <<<<<<< HEAD:vm/src/compiler/recursion_v2/ir/compiler.rs
    // =======
    ...
    // >>>>>>> main:vm/src/compiler/recursion_v2/circuit/compiler.rs
    ...
    fn fri_fold(
        ...
        CircuitV2FriFoldInput {
            ...
            alpha_pow_input,
            ro_input,
        }: CircuitV2FriFoldInput<FC>,
    ) -> Instruction<FC::F> {
        Instruction::FriFold(Box::new(FriFoldInstr {
            // Calculate before moving the vecs.
            alpha_pow_mults: vec![FC::F::ZERO; alpha_pow_output.len()],
            ro_mults: vec![FC::F::ZERO; ro_output.len()],
