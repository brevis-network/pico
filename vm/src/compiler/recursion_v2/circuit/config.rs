...
use crate::{compiler::recursion_v2::ir::DslIr, configs::config::SimpleFriConfig};
use crate::{
    ...
    instances::configs::{
        embed_config::{
            FieldConfig as EmbedFC, SC_ValMmcs as EmbedValMmcs, StarkConfig as EmbedSC,
        },
        recur_config::FieldConfig as RecurFC,
    },
...
impl CircuitConfig for RecurFC {
...
impl CircuitConfig for EmbedFC {
