...
use crate::{
    ...
    machine::{estimator::EventSizeCapture, field::same_field, report::EmulationReport},
...
impl RiscvEmulator {
    ...
    ) -> Result<Option<EmulationReport>, EmulationError>
    where
        F: FnMut(EmulationRecord),
    {
        ...
        let report = done.then(|| EmulationReport {
