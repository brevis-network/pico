...
use crate::{
    chips::chips::recursion_memory::{MemoryReadSingleCols, MemoryReadWriteSingleCols},
...
impl<const DEGREE: usize, F: Field> ExpReverseBitsLenChip<DEGREE, F> {
    pub fn eval_exp_reverse_bits_len<AB: ChipBuilder<F>>(
        &self,
        builder: &mut AB,
...
impl<F: Field, AB, const DEGREE: usize> Air<AB> for ExpReverseBitsLenChip<DEGREE, F>
where
    AB: ChipBuilder<F>,
{
