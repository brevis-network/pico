...
use super::{columns::SELECTOR_COL_MAP, CpuChip, CpuCols};
use crate::{
    ...
    AB: ChipBuilder<F>,
{
    fn eval(&self, builder: &mut AB) {
        ...
        builder.recursion_looking_program(
            local.pc,
            local.instruction,
            local.selectors,
            local.is_real,
        ...
        builder.recursion_looking_table(local.instruction.opcode, &operands, send_syscall);
