...
pub(crate) type BabyBearPoseidon2Chip<F> = Poseidon2ChipP3<
    F,
...
pub(crate) type KoalaBearPoseidon2Chip<F> = Poseidon2ChipP3<
    F,
    <F as FieldSpecificPoseidon2Config>::LinearLayers,
...
pub(crate) type Mersenne31Poseidon2Chip<F> = Poseidon2ChipP3<
    F,
    <F as FieldSpecificPoseidon2Config>::LinearLayers,
