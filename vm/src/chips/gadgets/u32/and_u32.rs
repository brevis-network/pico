...
mod tests {
    ...
    struct TestCols<T> {
        b: [T; 2],
        c: [T; 2],
        and_u32: AndU32Gadget<T>,
        is_real: T,
    }

    #[test]
    fn test_and_u32_gadget_simple_eval() {
        ...
        let _ = AndU32Gadget::<KoalaBear>::eval(
            &mut builder,
