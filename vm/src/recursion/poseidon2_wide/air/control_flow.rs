...
impl<const DEGREE: usize, F: Field> Poseidon2WideChip<DEGREE, F> {
    ...
    pub(crate) fn eval_control_flow<AB: ChipBuilder<F>>(
        &self,
        builder: &mut AB,
    ...
    fn eval_global_control_flow<AB: ChipBuilder<F>>(
        &self,
        builder: &mut AB,
    ...
    #[allow(clippy::too_many_arguments)]
    fn eval_hash_control_flow<AB: ChipBuilder<F>>(
        &self,
        builder: &mut AB,
        local_control_flow: &ControlFlow<AB::Var>,
        local_opcode_workspace: &OpcodeWorkspace<AB::Var>,
        ...
        // Constrain the materialized control flow flags.
        {
            ...
            absorb_builder.assert_eq(
                ...
                local_control_flow.is_syscall_row * local_hash_workspace.is_last_row::<F, AB>(),
            );
            absorb_builder.assert_eq(
            ...
            absorb_builder.assert_eq(
                ...
                local_hash_workspace.is_last_row::<F, AB>() * last_row_ending_cursor_is_seven,
            );
            absorb_builder.assert_eq(
            ...
            builder.assert_eq(
                ...
                local_control_flow.is_absorb * local_hash_workspace.is_last_row::<F, AB>(),
            );
        ...
        {
            // Drop absorb_builder so that builder can be used in the IsZeroGadget eval.
            IsZeroGadget::<AB::F>::eval(
                builder,
