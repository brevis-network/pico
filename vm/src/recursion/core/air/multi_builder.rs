use crate::machine::builder::{ChipBuilder, LookupBuilder, PublicValuesBuilder};
...
impl<'a, F: Field, AB: ChipBuilder<F>> ChipBuilder<F> for MultiBuilder<'a, AB> {
...
impl<'a, AB: AirBuilder + LookupBuilder<M>, M> LookupBuilder<M> for MultiBuilder<'a, AB> {
    fn looking(&mut self, message: M) {
        self.inner.looking(message);
    }

    fn looked(&mut self, message: M) {
        self.inner.looked(message);
    }
}

impl<'a, AB: AirBuilder + PublicValuesBuilder> PublicValuesBuilder for MultiBuilder<'a, AB> {
