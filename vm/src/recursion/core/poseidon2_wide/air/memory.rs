...
impl<const DEGREE: usize, F: Field> Poseidon2WideChip<DEGREE, F> {
    ...
    pub(crate) fn eval_mem<AB: ChipBuilder<F>>(
        &self,
        builder: &mut AB,
        ...
        // Verify the start_addr column.
        {
            ...
            builder.when(control_flow.is_absorb_not_last_row).assert_eq(
                ...
                local_memory.start_addr + opcode_workspace.absorb().num_consumed::<F, AB>(),
            );
    ...
    fn eval_absorb_memory_slots<AB: ChipBuilder<F>>(
        &self,
        builder: &mut AB,
        control_flow: &ControlFlow<AB::Var>,
        local_memory: &Memory<AB::Var>,
        ...
        absorb_builder
            .when_not(opcode_workspace.absorb().is_last_row::<F, AB>())
        ...
        absorb_builder
            .when(opcode_workspace.absorb().is_last_row::<F, AB>())
            .assert_eq(
                end_mem_idx,
