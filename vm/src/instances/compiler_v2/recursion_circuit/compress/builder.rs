...
use crate::{
    ...
    primitives::consts::{
        ADDR_NUM_BITS, COMBINE_DEGREE, CONVERT_DEGREE, DIGEST_SIZE, EMPTY, MAX_LOG_CHUNK_SIZE,
...
impl CompressVerifierCircuit<RecursionFC, RecursionSC> {
    pub fn build(
        machine: &BaseMachine<RecursionSC, RecursionChipType<Val<RecursionSC>, COMBINE_DEGREE>>,
        input: &RecursionStdin<RecursionSC, RecursionChipType<Val<RecursionSC>, COMBINE_DEGREE>>,
    ...
    CC: CircuitConfig<F = SC::Val, EF = SC::Challenge>,
{
    pub fn build_verifier(
        ...
        machine: &BaseMachine<SC, RecursionChipType<SC::Val, COMBINE_DEGREE>>,
